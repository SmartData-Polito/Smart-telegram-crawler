...
def main():
    ...
    for topic in topics_data:
        ...
        prompt = f"""Analyze this topic from a topic model and determine if it is about EXTREMISTS AND RADICALS.

NOT EXTREMIST:
- Normal political discussion (even heated)
- News about conflicts/wars (journalism)
- Government criticism without incitement to violence
- Peaceful activism
- Controversial but non-violent opinions
- Military history or academic discussion
...
"""
        ...
        prompt += "\nBased on the keywords and messages above, is this topic about EXTREMISTS AND RADICALS?\nAnswer with ONLY 'yes' or 'no'."
