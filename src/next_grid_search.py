...
#output paths
output_path_df_sampled = "../final/next/next_df_sampled.csv"
out_path_next_grid_search_results = '../final/next/next_grid_search_results.csv'
next_model_dir = "../final/next/next_bertopic_models"
next_vectorizer_dir = "../final/next/next_vectorizers"
...
for model_name, model_instance in tqdm(models.items()): #'all-distilroberta-v1', 'paraphrase-MiniLM-L6-v2'..
    path_next_emb = f'../final/next/next_final_embeddings_{model_name}.npy'
